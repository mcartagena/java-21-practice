...
public class StudentDataBase {
    ...
    public static List<Student> getAllStudents() {
         ...
         * 2nd grade students
         */
        Student student1 = new Student("Adam", 2, 3.6, "male", Arrays.asList("swimming", "basketball", "volleyball"), 3);
        Student student2 = new Student("Jenny", 2, 3.8, "female", Arrays.asList("swimming", "gymnastics", "soccer"), 5);
        /**
         * 3rd grade students
         */
